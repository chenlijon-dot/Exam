  ...
  function showBctYears() {
    ...
    content().innerHTML = `
      ...
      <div class="catalog-grid">
        ...
        ${card({id:'bct96Btn',icon:'🗓️',title:'96 年度',badge:'已收錄',desc:'第一次數學科 33 題、官方答案、原卷附圖與逐題詳解已建立；第二次待匯入。'})}
      </div>`;
  ...
  function showBct96Sessions() {
    ...
    content().innerHTML = `
      ...
      <div class="catalog-grid">
        ...
        ${card({id:'bct96SecondBtn',icon:'2️⃣',title:'第二次',badge:'待匯入',desc:'96 年度第二次基測尚未匯入。',disabled:true})}
      </div>`;
