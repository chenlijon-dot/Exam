(() => {
  ...
  const CHAPTERS = {
    ...
    'civics-03': {
      title: '第3章　家庭生活',
      subtitle: '第3章｜選擇難度',
      path: 'chapter-bank/social/7-1/civics/chapter-03',
      questionCount: 20,
      pointsPerQuestion: 5,
      subjectName: '公民',
      backText: '公民章節',
  ...
  document.addEventListener('click', event => {
    const chapter = event.target.closest?.('[data-social-chapter="geo-01"], [data-social-chapter="geo-02"], [data-social-chapter="geo-03"], [data-social-chapter="geo-04"], [data-social-chapter="hist-01"], [data-social-chapter="hist-02"], [data-social-chapter="hist-03"], [data-social-chapter="civics-01"], [data-social-chapter="civics-02"], [data-social-chapter="civics-03"]');
    if (!chapter) return;
