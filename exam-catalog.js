      ...
      chapters: [
        {
          ...
          referenceReady: true,
          detail: 'p.166～173 教材已收錄；1-1 什麼是公民？（p.168）｜1-2 現代公民應具備的基本德性（p.170）｜課後閱讀與圖解公民已納入；辨識檔、canonical、簡易／中等／困難各20題與各校題庫已建立'
        },
        {
          key: 'civics-02', code: '第2章', title: '人性尊嚴與人權保障', page: 174, type: 'chapter',
          referenceReady: true,
          detail: 'p.174～183 教材已收錄；2-1 人性尊嚴與人權（p.176）｜2-2 人權保障的落實（p.178）｜實作與練習、課後閱讀與圖解公民已納入；辨識檔、canonical、簡易／中等／困難各20題與各校題庫已建立'
        },
        {
