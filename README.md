...
96-2 數學：33 題
97-1 數學：34 題
97-2 數學：34 題（文字／答案已建立，圖片待上傳）
```

90～96 各年度第一次、第二次數學皆已完成；97-1 數學目前已建立 34 題文字、官方答案、永久 `questionId` / `revision: 1`、18 個圖題與 19 張原卷裁圖、34 題逐題詳解，並完成第二輪 QA 與歷屆 UI 掛載。已上線共 15 份數學考卷、483 題。
...
→ 17 張裁圖已確認
→ 15 題 imagePending
→ Q27、Q29 為 optionImagePending
→ 下一步由 PowerShell 5.1 上傳圖檔
```
