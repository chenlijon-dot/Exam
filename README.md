...
90～96 各年度第一次、第二次數學皆已完成；97-1、97-2、98-1、98-2、99-1、99-2 也皆已建立完整文字、官方答案、永久 `questionId` / `revision: 1`、原卷裁圖、逐題詳解，並完成第二輪 QA 與歷屆 UI 掛載。已上線共 20 份數學考卷、653 題。
...
96-2 目前已完成 33 題、官方答案、原卷附圖、逐題詳解與 UI 掛載；截至 2026-09-21，90～96 年第一次、第二次數學共 449 題皆已建立永久 `questionId` 與 `revision: 1`。
...
→ 34 題文字
→ 官方答案
→ 永久 questionId + revision: 1
→ Google Drive 97年第一次數學科_cropped/
→ crop_manifest.txt
→ 18 個圖題
→ 19 張 PNG
→ Q30 拆成題目長條圖 + 四個盒狀圖選項
...
→ 官方答案
→ 永久 questionId + revision: 1
→ Google Drive 97年第二次數學科_cropped/
→ crop_manifest.txt
→ 17 張 PNG
→ 15 題 image
→ Q27、Q29 使用 optionImage
→ imagePending / optionImagePending = 0
→ 34 題逐題詳解
→ 第二輪 QA
→ UI 掛載
...
```text
Stage 1：34 題文字骨架 + 官方答案 + expectedImages mapping
→ Stage 2：使用者以 PowerShell 5.1 上傳 17 張 PNG
→ remote read-back 17 / 17
→ 15 個圖題；13 題 image + Q9、Q20 各 image + optionImage
→ Q10 pending 回原卷解除
→ 第二輪 QA
→ 34 題逐題詳解
→ 批次核發永久 questionId + revision: 1
...
```text
Stage 1：34 題文字骨架 + 官方答案 + expectedImages mapping
→ Stage 2：使用者以 PowerShell 5.1 上傳 20 張 PNG
→ remote read-back 20 / 20
→ 18 個圖題；Q13、Q29 各 image + optionImage；Q11、Q30 使用 optionImage
→ Q27 pending 回原卷解除
→ 第二輪 QA
→ 34 題逐題詳解
→ 批次核發永久 questionId + revision: 1
...
目前歷史第2章〈大航海時代各方勢力的競逐〉已完成第一輪教材建置：
...
已完成題庫：
歷史第2章〈大航海時代各方勢力的競逐〉：簡易／中等／困難各 20 題，共 60 題，已接入 GitHub Pages 題庫系統
...
目前第一～八回均已建立正式 JSON 並在 registry 中為 `ready: true`；後續第九～十二回依 Drive authority 完成轉檔並正式上線時，再各自發新的永久 `questionId`。
...
- [x] 數學七上 1-1〈正數與負數〉自編題庫：簡易 20 題／中等 10 題／困難 12 題（10 選擇＋2 手寫），共 42 題；8 題直接使用 number-line SVG renderer
- [x] 數學七上 1-2〈正負數的加減〉自編題庫：簡易 20 題／中等 10 題／困難 12 題（10 選擇＋2 手寫），共 42 題；8 題直接使用 number-line SVG renderer
- [x] 數學七上 1-3〈正負數的乘除〉自編題庫：簡易 20 題／中等 10 題／困難 12 題（10 選擇＋2 手寫），共 42 題；涵蓋乘除符號、多因數判號、運算順序、分配律與情境題
- [x] 數學七上 1-4〈指數記法與科學記號〉自編題庫：簡易 20 題／中等 10 題／困難 12 題（10 選擇＋2 手寫），共 42 題；涵蓋負底數、10 的整數次方、科學記號轉換、位數與數量級比較
- [x] 自然 1-1、1-2、1-3 題庫工作流；1-1 已加入新無敵自然自修題庫
- [x] 自然 2-1、2-2 題庫入口與新無敵自然自修題庫
- [x] 社會地理第1章、第2章三級文字自編題庫
- [x] 社會地理第3章〈地形〉教材 canonical（p.34～47）
- [x] 社會地理第3章〈地形〉文字自編題庫：簡易／中等／困難各 20 題，共 60 題
- [x] 社會地理第4章〈海岸與島嶼〉教材 canonical（p.48～59）
- [x] 社會地理第4章〈海岸與島嶼〉文字自編題庫：簡易／中等／困難各 20 題，共 60 題
- [x] 社會歷史第1章〈史前臺灣與原住民文化〉（含導言）文字自編題庫：簡易／中等／困難各 20 題，共 60 題
- [x] 社會歷史第2章〈大航海時代各方勢力的競逐〉文字自編題庫：簡易／中等／困難各 20 題，共 60 題
- [x] 社會歷史第3章〈大航海時代臺灣原住民與外來者〉教材 canonical（p.118～125）；簡易／中等／困難各 20 題，共 60 題，已接入 GitHub Pages 題庫系統
- [x] 社會公民第1章〈公民與公民德性〉教材 canonical（p.166～173）；簡易／中等／困難各 20 題，共 60 題，已接入 GitHub Pages 題庫系統
- [x] 社會公民第2章〈人性尊嚴與人權保障〉教材 canonical（p.174～183）；簡易／中等／困難各 20 題，共 60 題，已接入 GitHub Pages 題庫系統
- [x] 社會公民第3章〈家庭生活〉教材 canonical（p.184～193）；教材辨識、考點／迷思／concept ID 與簡易／中等／困難各 20 題，共 60 題皆完成，已接入 GitHub Pages 題庫系統
- [x] 各校段考拆題 SOP
- [x] 正式歷屆考題 SOP
...
---
## 數學七上 1-3 自編題庫里程碑（2026-09-21）

`1-3 正負數的乘除` 已正式接入 GitHub 題庫系統：
...
---
## 數學七上 1-4 自編題庫里程碑（2026-09-21）

`1-4 指數記法與科學記號` 已正式接入 GitHub 題庫系統：
...
- [ ] 英文 GEPT 閱讀第九～十二回依 Drive authority 逐步轉為 GitHub 可作答資料
