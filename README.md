...
- [x] 數學七上 1-3〈正負數的乘除〉自編題庫：簡易 20 題／中等 10 題／困難 10 題，共 40 題；涵蓋乘除符號、多因數判號、運算順序、分配律與情境題
- [x] 數學七上 1-4〈指數記法與科學記號〉自編題庫：簡易 20 題／中等 10 題／困難 10 題，共 40 題；涵蓋負底數、10 的整數次方、科學記號轉換、位數與數量級比較
