...
目前第一～九回均已建立正式 JSON 並在 registry 中為 `ready: true`；後續第十～十二回依 Drive authority 完成轉檔並正式上線時，再各自發新的永久 `questionId`。
...
- [ ] 英文 GEPT 閱讀第十～十二回依 Drive authority 逐步轉為 GitHub 可作答資料
